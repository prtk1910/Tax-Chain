...
<html>
	...
	<body>
		<div class="container">
			<h1><a href="./">Income Tax Portal (Admin)</a><?php if (strlen($name)) { ?> &ndash; <?php echo html($name)?><?php } ?></h1>
<?php
	if (strlen($chain)) {
		$name=@$config[$chain]['name'];
?>
			...
			<nav class="navbar navbar-default">
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li><a href="./?chain=<?php echo html($chain)?>&page=create">Create User</a></li>
						<!-- <li><a href="./?chain=<?php //echo html($chain)?>&page=publish">Publish</a></li> -->
						<li><a href="./?chain=<?php echo html($chain)?>&page=view">View Records</a></li>
					</ul>
				</div>
			</nav>
